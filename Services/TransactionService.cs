...
public class TransactionService : ITransactionService
{
    ...
    {
        // SQLite cannot translate Sum over decimal in some group-by queries to SQL.
        // Materialize the relevant transactions into memory and aggregate there.
        ...
        return txns
            .GroupBy(t => t.Category?.Name ?? string.Empty)
